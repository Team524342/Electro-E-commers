...
CREATE TABLE `store_cartitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `store_cartitem_user_id_3ff2f2b5_fk_store_user_id` (`user_id`),
  ...
  CONSTRAINT `store_cartitem_user_id_3ff2f2b5_fk_store_user_id` FOREIGN KEY (`user_id`) REFERENCES `store_user` (`id`),
